...
public class Codes {
    ...
    public static class Index extends Code {
        ...
        public List<Code> getIndex() {
            return index;
        }

        public void setIndex(List<Code> index) {
            this.index = index;
        }
    ...
    public static class Reference extends Code {
        ...
        private Code currentChain;
        private Code restOfChains;

        public Code getCurrentChain() {
            return currentChain;
        }

        public void setCurrentChain(Code currentChain) {
    ...
    public static class Break extends Code {

    }

    public static class Empty extends Code {
